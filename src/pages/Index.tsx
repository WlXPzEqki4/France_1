      ...
      <footer className={`bg-navy-dark text-white py-12 mt-20 w-full transition-all duration-300 ${sidebarOpen ? 'md:pl-[280px]' : 'pl-0'}`}>
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">UAE-France Relations</h3>
              <p className="text-sm text-gray-300">
                An interactive analysis of diplomatic, economic, and strategic ties between 
                the United Arab Emirates and France from 2019 to 2024.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                ...
                <li><a href="#sweden-mb" className="hover:text-white transition-colors">France's Key Positions</a></li>
              </ul>
            </div>
            <div>
              ...
              <p className="text-sm text-gray-300">
                ...
                multifaceted relationship between the UAE and France, including key 
                stakeholders, points of alignment, and areas for future cooperation.
              </p>
            </div>
          </div>
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-sm text-gray-400">
            <p>© 2024 UAE-France Relations Analysis</p>
          </div>
        </div>
      </footer>
    </div>
