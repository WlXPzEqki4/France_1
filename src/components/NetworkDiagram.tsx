...
const NetworkDiagram: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center">
      <h2 className="text-2xl font-bold mb-4 font-display text-navy-dark">UAE-France Content Network Analysis</h2>
      <p className="text-center text-gray-600 mb-6">Interactive analysis of central topics to UAE-France relations</p>
